...
<div class="transbox">
  <br>
<ul>
  <li style="float: left;border-right:1px solid #bbb;"><a href="#home"><b>HOME</b></a></li>
  <li style="float: left;border-right:1px solid #bbb;"> <a href="#contact"><b>SERVICES</b></a></li>
  <li style="float: left;border-right:1px solid #bbb;"><a href="#contact"><b>CONTACT</b></a></li>
  <li style="float: left;border-right:1px solid #bbb;"><a href="#About"><b>ABOUT US</b></a></li>
  <li style="float:right"><a class="active" href="logout.php"><b>Logout</b></a></li>
</ul>
<br>
<a name="Home">
<h1 style="text-align:center;">Grand Hotel Kenya</h1>
...
<br>
<li><a href="#Amenities">Amenities</li>
<br>
<li><a href="#Gallery">Gallery</li>
<br>
<li><a href="#Rooms">Our Rooms</li>
<br>
</ul>
</div>
